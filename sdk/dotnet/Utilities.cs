...
namespace Pulumi.Securebaseline
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Securebaseline.version.txt");
    ...
    internal sealed class SecurebaselineResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public SecurebaselineResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
